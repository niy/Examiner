		...
		<div class="info_box clearfix" >
			...
			<div class="content clearfix">
				...
				<ul>
                    ...
                    $db = new db(1);
					if (_DBNAME == "examiner") {
						if ($db->db_query('CREATE DATABASE examiner CHARACTER SET utf8 COLLATE utf8_unicode_ci;', $db)) {
					...
					//Users
					if ($db->db_query('CREATE TABLE users (id INT NOT NULL AUTO_INCREMENT, FName VARCHAR(30), LName VARCHAR(30), fatherName VARCHAR(30), userid VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, email VARCHAR(50), PRIMARY KEY  (id))', $db)) {
					...
					//Questions
					if ($db->db_query('CREATE TABLE questions (id INT NOT NULL AUTO_INCREMENT, test_id INT NOT NULL, question TEXT NOT NULL, choice1 TEXT, choice2 TEXT, choice3 TEXT, choice4 TEXT, answer TINYINT(5) NOT NULL, PRIMARY KEY (id))', $db)) {
						echo '<li> Table "questions" created successfully</li>';
					} else {
						echo '<li class="incorrect">Error ocurred at creating table</li>';
					}
					//User_Test
					if ($db->db_query('CREATE TABLE user_test (id INT NOT NULL AUTO_INCREMENT, user_id INT, test_id INT, date DATE, time_length TINYTEXT, PRIMARY KEY (id))', $db)) {
						echo '<li>Table "user_test" created successfully</li>';
					} else {
						echo '<li class="incorrect"> Error ocurred at creating table</li>';
					}
					//User_Test_Questions
					if ($db->db_query('CREATE TABLE user_choice (id INT NOT NULL AUTO_INCREMENT, user_test_id INT NOT NULL, q_id INT NOT NULL, answer TINYINT(5), PRIMARY KEY (id))', $db)) {
						echo '<li>Table "user_choice" created successfully</li>';
					} else {
						echo '<li class="incorrect">Error ocurred at creating table</li>';
					}
					//System Settings
					if ($db->db_query('CREATE TABLE settings (id INT NOT NULL, admin_id VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, language VARCHAR(30), rtl TINYINT(1), PRIMARY KEY (id))', $db)) {
